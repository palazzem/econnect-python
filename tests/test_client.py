...
def test_client_get_alerts_status(server):
    ...
    # Expected output
    assert alerts == {
        0: {"name": "alarm_led", "status": False},
        1: {"name": "anomalies_led", "status": True},
        2: {"name": "device_failure", "status": False},
        3: {"name": "device_low_battery", "status": False},
        4: {"name": "device_no_power", "status": False},
        5: {"name": "device_no_supervision", "status": False},
        6: {"name": "device_system_block", "status": False},
        7: {"name": "device_tamper", "status": False},
        8: {"name": "gsm_anomaly", "status": False},
        9: {"name": "gsm_low_balance", "status": False},
        10: {"name": "has_anomaly", "status": False},
        11: {"name": "input_alarm", "status": False},
        12: {"name": "input_bypass", "status": False},
        13: {"name": "input_failure", "status": False},
        14: {"name": "input_low_battery", "status": False},
        15: {"name": "input_no_supervision", "status": False},
        16: {"name": "inputs_led", "status": True},
        17: {"name": "module_registration", "status": False},
        18: {"name": "panel_low_battery", "status": False},
        19: {"name": "panel_no_power", "status": False},
        20: {"name": "panel_tamper", "status": False},
        21: {"name": "pstn_anomaly", "status": False},
        22: {"name": "rf_interference", "status": False},
        23: {"name": "system_test", "status": False},
        24: {"name": "tamper_led", "status": False},
    }
